...
| وضعیت | سند | دامنه |
| --- | --- | --- |
| Active | `pmcs-post-v1-product-evolution.md` — `PMCS-RM-POST-V1-001 v1.24.0` | V1.1، V1.2 و V2.x |
...
| V1.1 RPT1 Slice 07 MS02 | F02 weekly/monthly DoR + semantic/source/cutoff/status/security/Golden contract / Runtime not implemented / candidate qualification pending |
