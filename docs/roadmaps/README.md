...
| وضعیت | سند | دامنه |
| --- | --- | --- |
| Active | `pmcs-post-v1-product-evolution.md` — `PMCS-RM-POST-V1-001 v1.22.0` | V1.1، V1.2 و V2.x |
...
| V1.1 RPT1 Slice 07 MS01 | ADR 0031 / ten-family catalog scope preserved / F02–F10 required as independent Micro-Slices / decision candidate qualification pending |
