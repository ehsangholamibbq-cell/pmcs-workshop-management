...
internal static class ProjectEndpoints
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Results.Ok(await readinessEvaluator.EvaluateAsync(project, cancellationToken));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var readiness = await readinessEvaluator.EvaluateAsync(project, cancellationToken);
